...
{
    public enum AI_State { idle, walk, fire};
    ...
    Animator animator;
    Blackboard bb;
    bool[] aggrodEnemiesIndixes;
    public bool[] _aggrodEnemiesIndixes() => aggrodEnemiesIndixes;
    ...
    void Start()
    {
        ...
        aggrodEnemiesIndixes = new bool[PlayerManager.instance.transform.childCount];
        for (int i = 0; i < aggrodEnemiesIndixes.Length; ++i)
        {
            aggrodEnemiesIndixes[i] = false;
        }
    }
